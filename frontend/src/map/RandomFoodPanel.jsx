...
export default function RandomFoodPanel({ mapRef, backendUrl, isNarrow, placement, onClose, onSelectPlace }) {
    ...
    const draw = async (reset = false) => {
        ...
        setResult(null);
        try {
            const data = await fetchRandomPlace(backendUrl, centerRef.current, recentRef.current, { signal: controller.signal });
